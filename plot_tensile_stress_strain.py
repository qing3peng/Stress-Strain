...
def usage(msg=''):
    ss=''' Usage example: python ./plot_tensile_stress_strain.py result_CNT_tensile.dat --memo 'Defective CNT' --xlim 0 0.2 --ylim 0 60 --Yn 50
    '''
    ss += msg
    print(ss)
    return ss
...
parser.add_argument('--memo', help='memo',default='')
...
parser.add_argument('--tx', help='MaxNLocator',nargs=2,type=int,default=[0.005,0.7])
...
parser.add_argument('--kk', help='text position',nargs=2,type=int,default=[0,0])
